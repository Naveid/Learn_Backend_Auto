...
public class WeatherGetRequest {
    ...
    public void Test_02(){
        ...
        System.out.println("Test 2 Running with Responce code "+ resp.getStatusCode());
...
public void Test_03() {
        ...
        System.out.println("Test 3 Running with Responce code with inline values "+resp.getStatusCode());
        Assert.assertEquals(resp.statusCode(), 200);
    }
    @Test(groups={"WeatherApi"})
    public void Test_04() {
        ...
        System.out.println("Test 4 Running checking directly for the status code ");
    ...
    @Test(groups={"WeatherApi"})
    public void Test_05() {
        System.out.println("checking the response from the hit Json");
      Response resp =  given().param("q", "London").
                param("appid", "b6907d289e10d714a6e88b30761fae22").
                when()
                .get("http://samples.openweathermap.org/data/2.5/weather");
    ...
    @Test(groups={"WeatherApi"})
    public void Test_06() {
        System.out.println("Weather by city ID");
